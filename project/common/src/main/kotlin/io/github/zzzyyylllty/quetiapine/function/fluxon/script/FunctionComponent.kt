...
import io.github.zzzyyylllty.quetiapine.util.minimessage.mmStrictUtil
...
object FunctionComponent {
    fun init(runtime: FluxonRuntime) {
        ...
        runtime.exportRegistry.registerClass(FluxonComponentObject::class.java, "quetiapine:component")
    }
