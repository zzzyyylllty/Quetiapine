...
@CommandHeader(
    name = "quetiapine",
    aliases = ["rpg"],
    permission = "quetiapine.command.main",
    description = "Main Command of Quetiapine.",
    permissionMessage = "",
    permissionDefault = PermissionDefault.OP,
    newParser = false,
)
object QuetiapineMainCommand {

    @CommandBody
    val about = subCommand {
        execute<CommandSender> { sender, context, argument ->
            sender.infoS("<gradient:aqua:blue>Quetiapine</gradient> <#ccccff>$pluginVersion")
            ...
            sender.infoS("<#cc66ff>Use <blue>/quetiapine help</blue> for help.")
        }
    }
    @CommandBody
