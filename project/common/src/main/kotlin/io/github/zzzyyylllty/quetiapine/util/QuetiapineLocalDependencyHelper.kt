...
import io.github.zzzyyylllty.quetiapine.util.isClassExistsSafety
...
class QuetiapineLocalDependencyHelper {
...
fun replaceTestTexts(str: String): String {
    ...
    val replaced = str
        .replaceUnrelocated("!top.maplex.arim","!io.github.zzzyyylllty.quetiapine.library.arim")
        .replaceUnrelocated("!ink.ptms.um","!io.github.zzzyyylllty.quetiapine.library.um")
        .replaceUnrelocated("!com.alibaba", "!io.github.zzzyyylllty.quetiapine.library.alibaba")
        .replaceUnrelocated("!kotlinx.serialization", "!kotlinx.serialization170")
        .replaceUnrelocated("!io.github.projectunified.uniitem","!io.github.zzzyyylllty.quetiapine.library.uniitem")
        .replaceUnrelocated("!com.fasterxml.jackson","!io.github.zzzyyylllty.quetiapine.library.jackson")
        .replaceUnrelocated("!com.mojang.datafixers","!io.github.zzzyyylllty.quetiapine.library.datafixers")
        .replaceUnrelocated("!io.netty.handler.codec.http", "!io.github.zzzyyylllty.quetiapine.library.http")
        .replaceUnrelocated("!io.netty.handler.codec.rtsp", "!io.github.zzzyyylllty.quetiapine.library.rtsp")
        .replaceUnrelocated("!io.netty.handler.codec.spdy", "!io.github.zzzyyylllty.quetiapine.library.spdy")
        .replaceUnrelocated("!io.netty.handler.codec.http2", "!io.github.zzzyyylllty.quetiapine.library.http2")
        .replaceUnrelocated("!org.tabooproject.fluxon","!io.github.zzzyyylllty.quetiapine.library.fluxon")
        .replaceUnrelocated("!com.github.benmanes.caffeine","!io.github.zzzyyylllty.quetiapine.library.caffeine")
        .replaceUnrelocated("!org.kotlincrypto","!io.github.zzzyyylllty.quetiapine.library.kotlincrypto")
//        .replaceUnrelocated("!com.oracle.truffle","!io.github.zzzyyylllty.quetiapine.library.truffle")
//        .replaceUnrelocated("!org.graalvm.polyglot","!io.github.zzzyyylllty.quetiapine.library.polyglot")
    return replaced
}
